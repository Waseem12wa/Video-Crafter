"""
Subtitle Design 2 - Bold White on Black Box
Bold white text with solid black rounded background box.
"""
...
def get_design(aspect_ratio: str) -> SubtitleDesign:
    """
    Get Subtitle Design 2 configuration.
    Bold white text on solid black rounded rectangle background.
    
    Args:
        aspect_ratio: Video aspect ratio (e.g., '4:5', '9:16')
    
    Returns:
        SubtitleDesign object with Design 2 configuration
    """
    if aspect_ratio == "9:16":
        # Vertical video design
        return SubtitleDesign(
            bar_color=(0, 0, 0),           # Solid black background
            bar_opacity=1.0,               # Full opacity (solid black)
            ...
            font_path="fonts/Montserrat-ExtraBold.ttf", # Very bold font
        ...
        return SubtitleDesign(
            ...
            line_spacing=8,                # Tight line spacing
            corner_radius=15,              # Rounded corners on black box
            highlight_padding=(0, 0),      # No extra highlight padding
            box_shadow_offset=(0, 0),      # No shadow
            box_shadow_blur=0,
            box_shadow_alpha=0.0,
